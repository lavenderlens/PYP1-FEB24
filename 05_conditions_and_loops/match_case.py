...
The MATCH statement uses pater matching to test for equality
If a match is found for a value, the case for that value executes
there are lots of performance-based arguments for a nd against
that onlycome into play working with large datasets
